...
local city = os.getenv("AWW_WEATHER_CITY") or "Massachusetts, US"
local open_map_key = os.getenv("AWW_WEATHER_API_KEY") or 'fea50753b4942b9a99c4a5d2d80ef159'
...
local icon_widget = wibox.widget {
    ...
    layout = wibox.container.margin(brightness_icon, 0, 2, 1),
