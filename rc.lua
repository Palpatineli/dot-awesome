...
-- mytextclock = wibox.widget.textclock("%a %b %d", 60, "EST")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = beautiful.wibox_height or 20, bg = beautiful.bg_normal.."55"})
    ...
    s.mywibox:setup {
        ...
        wibox.container.margin(s.mytasklist, 5, 5), -- Middle widget
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            -- mykeyboardlayout,
            wibox.container.margin(widgets.binary_clock().widget, 5),
            wibox.container.margin(widgets.weather, 10, 10),
            wibox.container.margin(widgets.volume, 5),
            wibox.container.margin(widgets.battery, 5),
            wibox.container.margin(wibox.widget.systray(), 5),
            s.mylayoutbox,
        },
    }
end)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "#68", function () awful.spawn("rofi -show combi") end,
